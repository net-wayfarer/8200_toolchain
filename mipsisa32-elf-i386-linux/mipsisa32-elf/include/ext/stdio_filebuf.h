  ...
  template<typename _CharT, typename _Traits = std::char_traits<_CharT> >
    ...
    public:
      ...
      */
      ...
      // Broadcom/msieweke addition
      // This was added to allow redirecting cout for a telnet console.  Also
      // look in basic_file_stdio.c for sys_reopen().
      void
      redirect( void* __file )
      {
          _M_file.sys_reopen( __file, std::ios_base::openmode( 0 ) );
      }
    };
