...
// Called by the STL allocator when it needs to protect the allocation lists
// against reentrancy, locking the mutex.
//
// Parameters:  None.
//
// Returns:  Nothing.
//
void V2StlAllocMutexLock(void);


// Called by the STL allocator when it needs to protect the allocation lists
// against reentrancy, unlocking the mutex.
//
// Parameters:  None.
//
// Returns:  Nothing.
//
void V2StlAllocMutexUnlock(void);
...
*/
      _Lock() { V2StlAllocMutexLock(); }
      ~_Lock() { V2StlAllocMutexUnlock(); }
